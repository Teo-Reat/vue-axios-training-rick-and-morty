<template>
    <div class="inline-flex mb-12 mt-24">
        <button class="bg-teal-300 hover:bg-teal-400 text-teal-800 font-bold py-2 px-4"
                @click="goToPage(0)">
            First
        </button>
        <button class="bg-teal-300 hover:bg-teal-400 text-teal-800 font-bold py-2 px-4"
        ...
        <button v-for="(num, key) in pagesCount"
                :key="key"
                class="bg-teal-300 hover:bg-teal-400 text-teal-800 font-bold py-2 px-4"
